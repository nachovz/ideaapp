...
public class BannerProductoCarrito extends ParentBannerProducto{
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(producto.getImagen() == null) imageView.setImageDrawable(mContext.getResources().getDrawable(R.drawable.prod_background));
        else imageView.setImageBitmap(producto.getImagen());
